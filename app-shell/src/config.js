...
const config = {
  gcloud: {
    bucket: "fldemo-files",
    hash: "8d0fcd683ccf0bda4176b7f3a1ff89f4"
  },
  bcrypt: {
    saltRounds: 12
  },
  ...
  project_uuid: 'fc082198-5843-4962-adbc-72f6f6b54d07',
...
config.pexelsQuery = 'coffee beans and laptop';
