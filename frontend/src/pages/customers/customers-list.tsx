...
import { setRefetch, uploadCsv } from '../../stores/customers/customersSlice';
...
const CustomersTablesPage = () => {
  ...
  const hasCreatePermission =
    currentUser && hasPermission(currentUser, 'CREATE_CUSTOMERS');
    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox className='mb-6' cardBoxClassName='flex flex-wrap'>
          ...
          <div className='md:inline-flex items-center ms-auto'>
            <Link href={'/customers/customers-table'}>Switch to Table</Link>
          </div>
        </CardBox>
