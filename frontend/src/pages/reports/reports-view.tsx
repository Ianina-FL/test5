    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>ReportType</p>
            <p>{reports?.report_type}</p>
          </div>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>ReportFile</p>
            {reports?.report_file?.length ? (
              dataFormatter.filesFormatter(reports.report_file).map((link) => (
                <button
                  key={link.publicUrl}
