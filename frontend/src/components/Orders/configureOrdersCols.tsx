  ...
  return [
...

    {
      ...
      valueFormatter: ({ value }) =>
        dataFormatter.coffee_blendsManyListFormatter(value).join(', '),
      renderEditCell: (params) => (
        <DataGridMultiSelect {...params} entityName={'coffee_blends'} />
      ),
    },
