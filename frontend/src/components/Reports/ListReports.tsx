              ...
              >
                ...
                >
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>GeneratedAt</p>
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>ReportType</p>
                    <p className={'line-clamp-2'}>{item.report_type}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>ReportFile</p>
                    {dataFormatter
                      .filesFormatter(item.report_file)
                      .map((link) => (
                        <button
                          key={link.publicUrl}
                          onClick={(e) =>
