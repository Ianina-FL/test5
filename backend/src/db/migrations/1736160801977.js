module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('reports', 'report_type', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('orders', 'shipment_tracking', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('coffee_blends', 'stock_level', {
        transaction,
      });

      await queryInterface.removeColumn('coffee_blends', 'price', {
        transaction,
      });

      await queryInterface.removeColumn('coffee_blends', 'name', {
        transaction,
      });
      ...
      await queryInterface.dropTable('coffee_blends', { transaction });
